...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-shadow-950/90 backdrop-blur-lg border-b border-shadow-800/40">
      <div className="container-wide">
        <div className="flex items-center justify-between h-14">
          ...
          >
            ...
            <span className="font-heading text-base tracking-widest text-parchment-200 group-hover:text-gold-400 transition-colors duration-200">
              ELDEN BINGO
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-4">
                ...
                <NavLink
                  ...
                  className={({ isActive }) => cn(
                    ...
                    isActive 
                      ...
                      : 'text-parchment-400 hover:text-parchment-200 hover:bg-shadow-800/40'
                  )}
                >
                  {item.label}
                </NavLink>
            ...
            <div className="pl-4 border-l border-shadow-800">
              {loading ? (
                ...
                <button
                  onClick={login}
                  className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-[#5865F2]/90 hover:bg-[#5865F2] text-white text-sm font-ui transition-all duration-200"
                >
