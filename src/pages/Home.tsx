...
export function Home() {
  const { matches, loading, error, hasMore, loadMore, refresh } = useMatches({ limit: 9 })
        ...
        <div className="container-wide">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={refresh}
                className="p-1.5 text-shadow-500 hover:text-parchment-300 hover:bg-shadow-800 rounded-md transition-colors"
